CREATE
database if NOT EXISTS `ruyuan_eshop_market` default character set utf8 collate utf8_general_ci;
use
`ruyuan_eshop_market`;
...
VALUES (6, '1001001', '2001001', '100', 1, '2021-12-12 12:15:03', 500, '2021-11-26 14:29:43', '2021-12-12 12:15:03');
INSERT INTO `market_coupon`
VALUES (9, '1001002', '2001001', '101', 1, '2021-12-08 21:15:34', 500, '2021-11-26 14:29:43', '2021-12-08 21:15:34');
INSERT INTO `market_coupon`
VALUES (10, '1001003', '2001001', '102', 1, '2021-12-08 22:58:56', 500, '2021-11-26 14:29:43', '2021-12-08 22:58:56');
INSERT INTO `market_coupon`
VALUES (11, '1001004', '2001001', '103', 1, '2021-12-09 20:11:16', 500, '2021-11-26 14:29:43', '2021-12-09 20:11:16');
INSERT INTO `market_coupon`
VALUES (12, '1001005', '2001001', '104', 1, '2021-12-10 11:36:47', 500, '2021-11-26 14:29:43', '2021-12-10 11:36:47');
INSERT INTO `market_coupon`
VALUES (13, '1001006', '2001001', '105', 1, '2021-12-10 12:23:57', 500, '2021-11-26 14:29:43', '2021-12-10 12:23:57');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `market_coupon_config`
VALUES (2, '2001001', '测试优惠券', 2, 500, 1000, '2021-11-01 12:24:29', '2024-06-30 12:24:35', 1000, 1, 1, 2,
        '2021-11-28 12:25:17', '2021-11-28 12:25:29');
COMMIT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='会员中心的会员积分表';
...
(
    ...
    `gmt_modified`    datetime    NOT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='会员积分变动的明细表';
