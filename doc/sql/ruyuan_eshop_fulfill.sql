CREATE
database if NOT EXISTS `ruyuan_eshop_fulfill` default character set utf8 collate utf8_general_ci;
use
`ruyuan_eshop_fulfill`;
...
(
    ...
    KEY                       `idx_status_type` (`status`,`order_fulfill_type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb3 COMMENT='订单履约表';
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    KEY             `idx_ful_fill_id` (`fulfill_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb3 COMMENT='订单履约条目';

-- ----------------------------
-- Table structure for order_fulfill_log
-- ----------------------------
...
(
    ...
    `gmt_modified`   datetime                                               NOT NULL COMMENT '更新时间',
    PRIMARY KEY (`id`) USING BTREE,
    KEY              `idx_fulfill_id` (`fulfill_id`) USING BTREE,
...
-- ----------------------------
BEGIN;
INSERT INTO `seata_state_machine_def`
VALUES ('2eb2a79e13dd5e7f79300f61ec75381f', 'order_fulfill', '000001', 'SEATA', 'STATE_LANG', '订单履约流程', '1.0.0',
        '2021-12-12 11:36:54.458', 'AC',
