...
public class RedisLockKeyConstants {
     ...
     * 扣减商品库存锁
     */
    public static final String DEDUCT_PRODUCT_STOCK_KEY = "#DEDUCT_PRODUCT_STOCK_KEY:{0}:{1}";

    /**
     * 释放商品库存锁
     */
    public static final String RELEASE_PRODUCT_STOCK_KEY = "#RELEASE_PRODUCT_STOCK_KEY:{0}:{1}";
